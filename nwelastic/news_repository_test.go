			...
			[]*News{
				{
					...
					GeographicCodes: []string{"geographicCode1, geographicCode11"},
				...
				},
				{
					...
					GeographicCodes: []string{"geographicCode2, geographicCode22"},
	...
	tests := []struct {
	...
	}{
		{
			...
			&News{
				...
				GeographicCodes: []string{"geographicCode1, geographicCode2"},
				PublicationTime: defaultTime.Add(time.Minute),
				ReceivedTime:    defaultTime.Add(time.Minute),
			},
			nil,
